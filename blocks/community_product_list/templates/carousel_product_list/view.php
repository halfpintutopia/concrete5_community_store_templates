    ...
    <div class="container">
        <div class="store-product-list-block">
            <?php if ($products) { ?>
                ...
                <div id="productListCarousel" class="carousel slide multi-item-carousel" data-ride="carousel" data-interval="12000">
                    <div class="carousel-inner store-product-list row store-product-list-per-row-<?= $productsPerRow ?>" role="listbox">
                        ...
                        foreach ($products as $product) {
                            ...
                            <div class="carousel-item store-product-list-item <?= $activeclass; ?> <?= $itemActive ? 'active' : '' ?>" role="option">
                    ...
                    <!-- PREV and NEXT  -->
                    <a class="carousel-control-prev" href="#productListCarousel" role="button" data-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#productListCarousel" role="button" data-slide="next">
