        ...
        <div class="store-product-list-block">
            <?php if ($products) { ?>
                ...
                <div id="productListCarousel" class="carousel slide multi-item-carousel" data-ride="carousel" data-interval="12000">
                    <div class="carousel-inner row w-100 mx-auto flex-nowrap store-product-list store-product-list-per-row-<?= $productsPerRow ?>" role="listbox">

                        <?php
                        $i = 1;
                        $carouselActiveClass = true;
                        ...
                        foreach ($products as $product) {
                            ...
                            <div class="store-product-list-item carousel-item <?= $carouselActiveClass ? 'active' : '' ?> <?= $columnClass; ?> <?= $activeclass; ?>">
                ...
                <script>
                    $('#productListCarousel').on('slide.bs.carousel', function(e) {
