    ...
    <div class="container">
        <div class="store-product-list-block">
            <?php if ($products) { ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="productListCarousel" class="carousel slide multi-item-carousel" data-ride="carousel">
                            <div class="carousel-inner store-product-list store-product-list-per-row-<?= $productsPerRow ?>">
